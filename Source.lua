...
local Library = {
    Theme = {
        MainColor = Color3.fromRGB(76, 194, 255),
...
function SectionElements:CreateTextBox(name, placeholderText, initialValue, callback)
    ...
    TextBoxContainer.Parent = NameTextBox
    TextBoxContainer.BackgroundColor3 = Color3.fromRGB(65, 65, 65)
    TextBoxContainer.BackgroundTransparency = 1.000
    TextBoxContainer.Position = UDim2.new(0.764771521, -5, 0.400000006, -12)
    --TextBoxContainer.Position = UDim2.new(0.764771521, -12, 0.400000006, -12)
    TextBoxContainer.Size = UDim2.new(0, 52, 0, 19)
    TextBoxContainer.ZIndex = 5
    TextBoxContainer.Image = "rbxassetid://3570695787"
    TextBoxContainer.ImageColor3 = Color3.fromRGB(65, 65, 65)
    TextBoxContainer.ScaleType = Enum.ScaleType.Slice
    TextBoxContainer.SliceCenter = Rect.new(100, 100, 100, 100)
    TextBoxContainer.SliceScale = 0.030
    ...
    TextBoxInput.Text = tostring(initialValue)
